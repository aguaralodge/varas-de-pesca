module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // ---- 2) Si viene imagen nueva, subirla ----
    ...
    const updateResp = await fetch(`${SUPABASE_URL}/rest/v1/products?id=eq.${encodeURIComponent(id)}`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${SERVICE_KEY}`,
        apikey: SERVICE_KEY,
    ...
    return res.status(200).json({ ok: true, product: updateJson[0] });
  } catch (e) {
